...
################################################################################
# EXPERIMENT: Ten Tracks / Single Year
# BAHRAIN, AZERBAIJAN, UK, HUNGARY, BELGIUM, ITALY, SINGAPORE, JAPAN, QATAR, ABU DHABI / 2023
################################################################################
...
NUM_EPISODES=100000
YEARS=2023
TRACKS="BAHRAIN AZERBAIJAN UK HUNGARY BELGIUM ITALY SINGAPORE JAPAN QATAR ABU_DHABI"
