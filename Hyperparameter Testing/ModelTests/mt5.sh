...
################################################################################
# EXPERIMENT: Street Tracks / Single Year
# SAUDI ARABIA, AUSTRALIA, AZERBAIJAN, MIAMI, MONACO, CANADA, SINGAPORE, LAS VEGAS / 2023
################################################################################
...
NUM_EPISODES=100000
YEARS=2023
TRACKS="SAUDI_ARABIA AUSTRALIA AZERBAIJAN MIAMI MONACO CANADA SINGAPORE LAS_VEGAS"
