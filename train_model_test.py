...
def __main(args):
    ...
    drqn_model = DRQNModel(
        selected_driver=44,
        name=f"Model Test {args.experiment_number}",
        device=device,
    ...
    drqn_model.train(
        ...
        checkpointing_details={
            "checkpoint_directory": f"Saved Models/Model Tests/Model Test {args.experiment_number}",
    ...
    drqn_model.save_model(f"Saved Models/Model Tests/test_{args.experiment_number}")
