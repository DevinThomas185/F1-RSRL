...
def __main(args):
    ...
    dqn_model = DQNModel(
        selected_driver=44,
        name=f"DQN HPT{args.experiment_number}",
        device=device,
    ...
    dqn_model.train(
        ...
        checkpointing_details={
            "checkpoint_directory": f"Saved Models/DQN HPT/DQN Experiment {args.experiment_number}",
    ...
    dqn_model.save_model(f"Saved Models/DQN HPT/experiment_{args.experiment_number}")
