...
def __main(args):
    ...
    module = importlib.import_module("Architectures.HPT_RecurrentQN")
    architecture = getattr(module, f"HPT_{args.architecture_id}_RecurrentQN")
    ...
    drqn_model = DRQNModel(
        selected_driver=44,
        name=f"DRQN HPT{args.experiment_number}",
        device=device,
    ...
    drqn_model.train(
        ...
        checkpointing_details={
            "checkpoint_directory": f"Saved Models/DRQN HPT/DRQN Experiment {args.experiment_number}",
    ...
    drqn_model.save_model(f"Saved Models/DRQN HPT/experiment_{args.experiment_number}")
