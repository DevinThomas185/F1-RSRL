...
class CDQNModel(StrategyRLModel):
    __slots__ = [
        "__policy_network",
        "__target_network",
    ]
    ...
    def train(
        ...
        while i_episode <= end_episode:
            ...
            # Update the target network, copying all weights and biases in CDQN
    ...
    def save_model(
        self,
        file_name: str = "Saved Models/cdqn_model",
    ) -> None:
        super()._save_model(
            model_type=CDQNModel,
            checkpoints={
    ...
    def load_model(
        ...
        model = CDQNModel(
            ...
            name=checkpoint.get("name", "CDQNModel"),
            device=device,
